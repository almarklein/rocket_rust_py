...
class PtRocketGame(BaseRocketGame):
    ...
    def __init__(self):
        ...
        self._container = pt.layout.containers.Window(content=control)
        self._size = 0, 0
    ...
    def run(self):
        ...
        for key in ('space', 'up', 'left', 'right'):
            bindings.add(key)(self._press_key)
        bindings.add('escape')(lambda e: e.app.exit())
        
        app = pt.application.Application(layout=pt.layout.Layout(self._container),
    ...
    def paint(self, w, h):
        ...
        # Update and draw
        progress = min(0.5, time.time() - self._lasttime) * 0.1
        self._lasttime = time.time()
        ...
        return self._lines#[''.join(line) for line in lines]
    ...
    def _press_key(self, event):
        ...
        self._key_release[key] = time.time() + 0.5
